...
/// Aba "Agora": o conteúdo que o painel sempre mostrou, antes de existirem
/// abas. Extraído do `UsagePanel` para que acrescentar outras abas não
/// misture a mudança de layout com a de conteúdo.
struct NowTab: View {
